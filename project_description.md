...
This is a system that does research. Not “helps with research”—actually does it.

You give it a question, and it runs the entire scientific process end to end. It finds relevant work, forms a hypothesis, runs models on real data, and produces a result.

One input, one run, complete research output.
